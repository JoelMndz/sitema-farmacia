      ...
      <div class="col-md-12">
        <div class="card card-dark">
          ...
          <div class="card-body p-0">
            <header>
              <div class="logo_cp">
                <img src="../img/icon1.png" width="100" height="100">
              </div>
              ...
              <button id="actualizar"class="btn btn-primary mb-2">Actualizar</button>
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <div class="card-body">
                    <div class="info-box mb-3 p-0">
                      <span class="info-box-icon"><i class="fas fa-tag" style="color: var(--icon-color4)"></i></span>
                ...
                <div class="col-md-4">
                  <div class="card card-default">
                    ...
                    <div class="card-body">
                      <div class="info-box mb-3">
                        <span class="info-box-icon"><i class="fas fa-comment-dollar" style="color: var(--icon-color1)"></i></span>
                        <div class="info-box-content">
                ...
                <div class="col-md-4">
                  <div class="card card-default">
                    ...
                    <div class="card-body">
                    <div class="info-box mb-3">
                      <span class="info-box-icon"><i class="fas fa-money-bill-alt" style="color: var(--icon-color2)"></i></span>
                      <div class="info-box-content">
                    ...
                    <div class="info-box mb-3">
                      <span class="info-box-icon"><i class="fas fa-money-bill-wave" style="color: var(--icon-color1)"></i></span>
                      <div class="info-box-content">
            ...
            <div class="row justify-content-between">
              <div class="col-md-4 mb-2">
                <a href="../vista/adm_catalogo.php" class="btn btn-dark btn-block">Seguir Vendiendo</a>
              </div>
              <div class="col-xs-12 col-md-4">
                <a href="#" class="btn btn-primary btn-block" id="procesar-compra">Realizar Venta</a>
              </div>
            </div>
          </div>
        </div>
