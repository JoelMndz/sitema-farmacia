        ...
        <div class="card card-dark">
          ...
          <div class="card-body row">
              ...
              <div class="card p-3">
                ...
                <div class="alert alert-danger text-center" id="noadd-prod" style='display:none;'>
                  ...
                  <div class="form-group text-right">
                    <button class="agregar-producto btn bg-gradient-primary ml-2">Agregar</button>
                  </div>
              </div>
            ...
            <div class="card col-sm-12">
              ...
              <button class="crear-compra btn bg-gradient-dark text-center">Crear compra</button>
              </div>
          </div>
