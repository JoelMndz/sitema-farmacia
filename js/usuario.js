$(document).ready(function(){
  ...
  function buscar_usuario(dato){
    ...
    $.post('../controlador/UsuarioController.php',{dato,funcion},(response)=>{
      ...
      $('#avatar1').attr('src',usuario.avatar);//se reemplaza el avatar
  ...
  $('#form-photo').submit(e=>{
    ...
    $.ajax({
      ...
      if (json.alert=='edit'){
        ...
        buscar_usuario(id_usuario);//para refrescar y que cambie el avatar en todos lados
      }
      else{
        $('#noedit').hide('slow');
        $('#noedit').show('3000');
    ...
    e.preventDefault(); //eliminar el evento por defecto del submit (refrescar la página)
  })
})