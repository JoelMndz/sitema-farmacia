$(document).ready(function(){
  ...
  function mostrar_consultas(){
    ...
    $.post('../controlador/VentaCotroller.php', {funcion}, (response) =>{
  ...
  function listar_ventas(){
    ...
    datatable = $('#tabla_venta').DataTable( {
      ajax:{
        "url":"../controlador/VentaCotroller.php",
        "method": "POST",
      ...
      columns: [
          ...
          {defaultContent: `<button class="imprimir btn btn-secondary"><i class="fas fa-print"></i></button>
                            <button class="ver btn btn-primary" type="button" data-toggle="modal" data-target="#vista_venta"><i class="fas fa-search"></i></button>
  ...
  $('#tabla_venta tbody').on('click','.borrar', function(){
    ...
    swalWithBootstrapButtons.fire({
      title: 'Estas seguro que quieres borrar la venta: '+id+'?',
