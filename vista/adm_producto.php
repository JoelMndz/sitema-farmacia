    ...
    <div class="modal-content">
      <div class="card card-info">
        ...
        <div class="card-body">
          ...
          <div class="alert alert-success text-center" id="id_edit_prod" style="display:none;">
            <span><i class="fas fa-check m-1"></i>Se edito correctamente</span>
          </div>
          <form id="form-crear-producto">
            <div class="form-group">
              <label for="nombre_producto">Nombre</label>
              <input id="nombre_producto" type="text" class="form-control" placehoder="Ingrese nombre" required>
            </div>
            <div class="form-group">
              <label for="concentracion">Concentración</label>
              <input id="concentracion" type="text" class="form-control" placehoder="Ingrese la concentracion">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input id="precio" type="number" step="any" class="form-control" value='1' placehoder="Ingrese precio" required>
            </div>
            <div class="form-group">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <h1>Gestion producto 
            ...
            <button type="button" class="btn bg-gradient-dark ml-2" data-toggle="modal" data-target="#modalFormatoReporte">Reporte de Productos</button>
          </h1>
          </div>
          <div class="col-sm-6">
