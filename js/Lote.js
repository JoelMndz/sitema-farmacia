    ...
    $.post('../controlador/LoteController.php',{consulta,funcion},(response)=>{
      ...
      lotes.forEach(lote => {
        ...
        if(lote.estado=='light'){
          template+=`<div class="card  d-flex flex-fill" style="background: var(--dark-color3)">`;
        }
        ...
        if(lote.estado=='danger'){
          ...
          template+=`<div class="card-header-lote border-bottom-0 p-3">
          <h6>Código ${lote.codigo}</h6>
            <i class="fas fa-lg fa-cubes mr-1"></i>${lote.stock}
          </div>
          <div class="card-body-lote p-3">
            <div class="row">
              <div class="col-7">
          ...
          <div class="card-footer-lote p-3">
