        ...
        <div class="card-body">
          ...
          <form id="form-crear">
            ...
            <div class="form-group">
              ...
              <input id="apellido" type="text" class="form-control" placehoder="Ingrese apellido" required>
            </div>
            <div class="form-group">
              <label for="edad">Nacimiento</label>
              <input id="edad" type="date" class="form-control" placehoder="Ingrese nacimiento" required>
            </div>
            <div class="form-group">
              <label for="dpi">DPI</label>
              <input id="dpi" type="text" class="form-control" placehoder="Ingrese DPI" required>
            </div>
            <div class="form-group">
              <label for="pass">Contraseña</label>
              <input id="pass" type="password" class="form-control" placehoder="Ingrese contraseña" required>
            </div>
          </div>
