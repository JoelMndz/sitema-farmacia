  ...
  function buscar_producto(consulta){
    ...
    $.post('../controlador/ProductoController.php',{consulta,funcion},(response)=>{
      ...
      productos.forEach(producto => {
        template+=`
        <div prodId="${producto.id}" prodStock="${producto.stock}" prodNombre="${producto.nombre}" prodPrecio="${producto.precio}" prodConcentracion="${producto.concentracion}" prodAdicional="${producto.adicional}" prodLaboratorio="${producto.laboratorio_id}" prodTipo="${producto.tipo_id}" prodPresentacion="${producto.presentacion_id}" prodAvatar="${producto.avatar}" class="col-12 col-sm-12 col-md-6 d-flex align-items-stretch flex-column">
        <div class="card bg-light d-flex flex-fill">
          ...
          <div class="card-body catalogo pt-0" style="background: var(--dark-color3)">
            <div class="row">
              <div class="col-8">
                <h6 class="lead">Código: ${producto.id}</h6>
