        ...
        <div class="card-body">
          ...
          <form id="form-crear">
            ...
            <div class="form-group">
              ...
              <input id="telefono" type="number" class="form-control" placehoder="Ingrese telefono" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input id="direccion" type="text" class="form-control" placehoder="Ingrese direccion" required>
            </div>
